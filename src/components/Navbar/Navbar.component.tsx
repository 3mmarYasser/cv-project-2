        ...
        <div className="navbar bg-base-100 p-8">
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal px-1">
                    ...
                    <li><Link className="font-bold" to={"/"}>FAQ</Link></li>
                </ul>
            </div>

            <div className="navbar-end">
                <a className="btn btn-outline customize-btn font-bold">login</a>
                <a className="btn btn-primary customize-btn ">Get started</a>
